...
DAT.Globe = function (container, opts) {
  ...
  var colorFn =
    ...
    function (x) {
      ...
      // c.setHSL(0.441 + x / 2, 0.6, 0.75); //Original green color
      c.setHSL(0.125 - x / 5, 0.72, 0.5); //custom yellow color
      return c;
    };
  ...
  function zoom(delta) {
    ...
    distanceTarget = Math.max(350, Math.min(1100, distanceTarget));
  }
